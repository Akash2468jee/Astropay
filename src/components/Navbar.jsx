 ...
 * Displays dApp branding, network status, and quick wallet actions.
 */
            ...
            {publicKey ? (
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 text-slate-300 text-sm font-mono">
                  ...
                  {walletType && (
                    <span className="text-[9px] font-bold px-1.5 py-0.5 rounded bg-stellar-accent/10 text-stellar-accent border border-stellar-accent/20 capitalize font-sans">
                      {walletType}
                    </span>
                  )}
                </div>
